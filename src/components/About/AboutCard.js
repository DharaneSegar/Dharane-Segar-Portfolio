      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "center" }}>
            ...
            <br />
            <br />
            From August 2023 to January 2024, I worked as a Software Engineer Intern at <span className="purple">WSO2</span>, where I gained hands-on experience in building and deploying reusable domain-specific demos for industries like Banking and Airlines. During my internship, I was responsible for designing and implementing integration solutions using WSO2 products.
            <br />
            <br />
            I specialize in <span className="purple">full-stack development</span>, <span className="purple">mobile app development</span>, <span className="purple">cloud technologies</span>, and <span className="purple">machine learning</span>. I have experience in training machine learning models, including data preprocessing, feature engineering, and deploying models to solve real-world problems. I am proficient in a variety of programming languages and frameworks, including the <span className="purple">MERN stack</span>, <span className="purple">Java</span>, <span className="purple">Springboot</span>, <span className="purple">C#</span>, <span className="purple">Flutter</span>, <span className="purple">Kotlin</span>, <span className="purple">Python</span>, and <span className="purple">DBMS</span>. I am dedicated to leveraging these technologies to build innovative, user-friendly applications.
            <br />
            <br />
            In addition to my academic and internship experience, I have also worked on several freelancing projects, which have allowed me to apply my skills to real-world problems while gaining valuable client-facing experience.
            <br />
            <br />
